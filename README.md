...
Download Aya 0.7.6 from the GitHub release:

- macOS Apple Silicon: [DMG](https://github.com/khasinski/aya/releases/download/v0.7.6/Aya-0.7.6-arm64.dmg) or [zip](https://github.com/khasinski/aya/releases/download/v0.7.6/Aya-0.7.6-arm64-mac.zip)
- Linux x64: [AppImage](https://github.com/khasinski/aya/releases/download/v0.7.6/Aya-0.7.6.AppImage) or [deb](https://github.com/khasinski/aya/releases/download/v0.7.6/aya_0.7.6_amd64.deb)
...
```sh
sudo apt install ./aya_0.7.6_amd64.deb
/opt/Aya/aya
```
